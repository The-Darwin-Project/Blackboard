        ...
        <div className="flex-shrink-0 px-1.5 pt-2 pb-1 border-b border-border">
          <div className="flex flex-col gap-2 px-3 py-2 rounded-lg border"
            ...
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <SourceIcon source={doc.source} evidence={doc.event?.evidence as Record<string, unknown> | undefined} size={16} />
        ...
        <div className="flex-shrink-0 overflow-auto px-1.5 pb-1" style={{ maxHeight: '30%' }}>
          ...
          <CollapsibleSection title="Details">
            <div className="space-y-1.5 text-[13px] text-text-muted">
              <div className="flex justify-between"><span>Source</span><span className="flex items-center gap-1"><SourceIcon source={doc.source} evidence={doc.event?.evidence as Record<string, unknown> | undefined} size={18} />{doc.source}</span></div>
