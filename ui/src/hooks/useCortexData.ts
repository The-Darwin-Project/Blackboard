...
import { getCognitiveGraph, getCortexActivity, getKGServiceDetail, getKGServices, getKGStats, getRecentPulses } from '../api/client';
import type { KGServiceDetail, KGServiceEntity, KGStats } from '../api/types';
import type {
