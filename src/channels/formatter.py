...
def format_turn(turn: "ConversationTurn", event_id: str = "") -> list[dict]:
    ...
    elif turn.action == "cancel" and turn.actor in ("architect", "sysadmin", "developer", "qe", "security_analyst", "code_reviewer", "explorer"):
        blocks.append(_section(f":stop_button: *{turn.actor}* task cancelled"))

    elif turn.actor in ("architect", "sysadmin", "developer", "qe", "security_analyst", "code_reviewer", "explorer") and turn.result:
