...
# 23. [Pattern]: _sanitize_lesson_text() is a module-level helper (Layer 3 defense-in-depth).
#     Maps all known Brain tool names to behavioral descriptions via _TOOL_TO_BEHAVIOR dict (38 entries,
#     covering all BRAIN_TOOL_SCHEMAS names). Applied in store_lesson() before embed AND in dedup-merge
#     path. Does NOT import from src/agents/llm/ (hexagonal boundary); mapping maintained manually.
#     Test T-10 asserts the mapping stays in sync with BRAIN_TOOL_SCHEMAS.
"""
