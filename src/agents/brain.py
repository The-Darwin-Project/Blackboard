        ...
        if function_name in ("select_agent", "ask_agent_for_state"):
            ...
            if not slack_channel:
                ...
                try:
                    ...
                    event_context = f"*Event:* {event_doc.event.reason[:200]}\n\n" if is_bidirectional else ""
                    footer = "_Reply in this thread to follow up on this event._"
                    ...
                    if is_bidirectional:
                        ...
                        logger.info(f"Slack notification sent to {user_email} for event {event_id} (reply-capable, existing thread preserved)")
