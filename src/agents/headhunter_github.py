...
Agents: sysadmin (k8s/gitops), developer (code/PR/CI), qe (test/verify), architect (analysis/review), security_analyst (CVE/vulnerability/dependency audit/supply chain), code_reviewer (dedicated multi-lens review gate -- use when the review itself is the requested work, not architect's investigation-time opinion).
...
Agents: sysadmin (k8s/gitops), developer (code/implementation), qe (test/verify), architect (analysis/design), security_analyst (CVE/vulnerability/dependency audit/supply chain), code_reviewer (dedicated multi-lens review gate -- use when the review itself is the requested work, not architect's investigation-time opinion).
Risk drives plan shape: low (1-3 steps), medium (2-4 steps), high (1-2 probe steps).
"""
