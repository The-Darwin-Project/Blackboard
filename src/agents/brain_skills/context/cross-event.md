...
- If recently closed events show a PATTERN of repeated same-reason events (3+ closures of the same type), note the pattern in your escalation evidence. The Nightwatcher daemon clusters related incidents during its sweep cycle -- your job is accurate per-event evidence, not systemic root cause analysis across events.
