...
Agent rules live in `gemini-sidecar/rules/` (architect, developer, sysadmin, qe, security_analyst, code_reviewer). Skills live in `gemini-sidecar/skills/` (32 skills, role/mode filtered).
