...
// 4. [Gotcha]: requestFindings spawns a second CLI process -- keep timeout low (60s) and never reject.
// 5. [Gotcha]: fs.watch cachedFindings is captured by closure in spawn callbacks -- not in state.js.
