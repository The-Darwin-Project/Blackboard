...
Usage:
    export GCP_PROJECT=cnv-release-ops
    export GCP_LOCATION=us-east5
    export JIRA_EMAIL=thason@redhat.com
    export JIRA_API_TOKEN=<token>  # or source ~/.oh-my-bash/custom/jira-env.bash
...
GCP_PROJECT = os.getenv("GCP_PROJECT", "cnv-release-ops")
