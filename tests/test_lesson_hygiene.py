...
Validates the 4-layer defense:
  Layer 3: _sanitize_lesson_text in archivist.py (full behavioral mapping)
...
class TestSanitizeLessonText:
    """Mapped behavioral replacement sanitizer (complete vs BRAIN_TOOL_SCHEMAS)."""
...
class TestToolNameCoverage:
    ...
    def test_all_brain_tools_covered(self):
        ...
        assert not missing, (
            ...
            f"Add them to _TOOL_TO_BEHAVIOR so Layer 3 covers all tools."
        )
